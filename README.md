# sql
Descripcion: Este repositorio contiene 20 consultas SQL organizadas en 4 bloques temáticos sobre un sistema de clientes, productos y pedidos: (1) consultas básicas con filtros y ordenamiento, (2) agrupación y funciones de agregación, (3) actualización de datos, y (4) inserciones, subconsultas y eliminación. Todas las consultas están escritas en sintaxis PostgreSQL y fueron ejecutadas mediante DBeaver.
...
Contar con un modelo entidad-relación claro antes de escribir consultas evita ambigüedades como las encontradas en los nombres de columnas de este ejercici
